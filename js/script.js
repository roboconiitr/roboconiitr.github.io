$(document).ready(function(){
	...
	var $fabars = $(".fa-bars");
	var $libimg = $(".lib ul img");
	var $liblink = $(".lib_link");
	...
	$liblink.mouseover(function(){
		$(this).nextAll(1).stop().slideDown(400);
	});
	$liblink.mouseout(function(){
		$(this).nextAll(1).stop().slideUp(400);
	});
